...
public class CommonUtil
{
	...
	public static void setProgressDialogMessage(String message)
	{
		if(mDialogFragment == null)
			return;
		if(mDialogFragment.getDialog() != null && mDialogFragment.getDialog() instanceof ProgressDialog)
			((ProgressDialog)mDialogFragment.getDialog()).setMessage(message);
	}
	...
	public static void hideKeyboard(final Context pContext, final View pView)
	{
		...
		imm.hideSoftInputFromWindow(pView.getApplicationWindowToken(), 0);
